...
- qable_args:
  ...
  [`qable`](http://www.peteredewitt.com/qwraps2/dev/reference/qable.md)
...
- n_perc_args:
  ...
  [`n_perc`](http://www.peteredewitt.com/qwraps2/dev/reference/n_perc.md)
  to be used with `character` or `factor` variables within `x`.
...
[`qable`](http://www.peteredewitt.com/qwraps2/dev/reference/qable.md)
for marking up `qwraps2_summary_table` objects. The
[`vignette("qwraps2-summary-table", package = "qwraps2")`](http://www.peteredewitt.com/qwraps2/dev/articles/qwraps2-summary-table.md)
