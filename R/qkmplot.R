...
#' ggplot2 Kaplan-Meier plot. The misspelled
#' \code{qkmplot_bulid_data_frame} is retained as a deprecated
#' backward-compatible wrapper for \code{qkmplot_build_data_frame}.
#'
