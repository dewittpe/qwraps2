...
#' `DESCRIPTION` file, which you, the package developer, will need to edit.  The
...
system(paste0("cat ", pkg_dir, "/data-raw/makefile"))
...
system(paste0("cat ", pkg_dir, "/DESCRIPTION"))
