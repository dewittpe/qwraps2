...
The function `qkmplot_bulid_data_frame` can be used to generate a
...
and spam or not based on the Spambase \[@spambase\] data. More details
...
## [1] survival_3.8-3 qwraps2_0.6.2 
## 
## loaded via a namespace (and not attached):
##  [1] glmnet_4.1-10      Matrix_1.7-4       gtable_0.3.6       jsonlite_2.0.0    
##  [5] dplyr_1.2.0        compiler_4.5.2     tidyselect_1.2.1   Rcpp_1.1.1        
##  [9] jquerylib_0.1.4    splines_4.5.2      systemfonts_1.3.1  scales_1.4.0      
## [13] textshaping_1.0.4  yaml_2.3.12        fastmap_1.2.0      lattice_0.22-7    
## [17] ggplot2_4.0.2      R6_2.6.1           labeling_0.4.3     generics_0.1.4    
## [21] shape_1.4.6.1      knitr_1.51         iterators_1.0.14   tibble_3.3.1      
## [25] desc_1.4.3         bslib_0.10.0       pillar_1.11.1      RColorBrewer_1.1-3
## [29] rlang_1.1.7        cachem_1.1.0       xfun_0.56          fs_1.6.6          
## [33] sass_0.4.10        S7_0.2.1           cli_3.6.5          pkgdown_2.2.0     
## [37] withr_3.0.2        magrittr_2.0.4     foreach_1.5.2      digest_0.6.39     
## [41] grid_4.5.2         lifecycle_1.0.5    vctrs_0.7.1        evaluate_1.0.5    
