...
#'
#' We will build a sumamry table for a regression model with row groups for
...
#' is alphabeticall if the variable is just a character.
#'
...
#' reporting for the whole data sets and the additonal columns for subsets of
...
#' and then writting in the needed p-value on the wanted rows.  This could be
...
#' of the summary and the mpvals will be static. Remembering to make the
...
#' having to worry about the alignment of rows bewtween different elements:
